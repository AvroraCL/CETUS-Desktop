...
| 文件 | 说明 |
|---|---|
| [Cetus-Setup-0.3.0.exe](https://github.com/AvroraCL/CETUS-Desktop/releases/download/v0.3.0/Cetus-Setup-0.3.0.exe) | 中文安装向导，按当前用户安装，无需管理员权限 |
| [Cetus-0.3.0-win-x64-portable.zip](https://github.com/AvroraCL/CETUS-Desktop/releases/download/v0.3.0/Cetus-0.3.0-win-x64-portable.zip) | 便携版，解压后直接运行 |
...
- 便携版升级时请将新包解压到全新目录（或先删除旧目录中的 `runtime` 文件夹），直接覆盖解压会残留新旧混合的 Node 依赖树并导致 DSH 无法启动；安装版已自动处理。
